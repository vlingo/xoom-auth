...
public interface User {
  ...
  Completes<UserState> registerUser(final String tenantId, final String username, final boolean active, final Profile profile);

  static Completes<UserState> registerUser(final Stage stage, final String tenantId, final String username, final boolean active, final Profile profile) {
    ...
    return _user.registerUser(tenantId, username, active, profile);
  }

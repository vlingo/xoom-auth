...
@DataObjects({CredentialData.class, ConstraintData.class, UserRegistrationData.class, TenantData.class, PersonNameData.class, ProfileData.class, PermissionData.class, RoleView.class, GroupView.class})

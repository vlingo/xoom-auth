...
<MaterialApp theme={$theme}>
	<AppBar fixed style="width:100%">
		...
		<a href="." slot="title" class="text--primary"><span style="color: var(--theme-text-primary)"> VLINGO/AUTH </span></a>
		<div style="flex-grow:1" />
    	<a href="https://github.com/vlingo/vlingo-auth" target="_blank" rel="noopener">
